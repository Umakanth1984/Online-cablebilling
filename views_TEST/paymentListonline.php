...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Digital Cables  - Online Payments History
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Customer</a></li>
        <li class="active">Online Payments History</li>
      </ol>
    </section>
			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
					  <h3 class="box-title">Online Payments History</h3>
					</div>
					<form id="customerForm11" name="customerForm11" class="form-horizontal" role="form" method="post" autocomplete="off" action="<?php echo base_url()?>customer/onlinepayment">
						<div class="box-body">
						   ...
						   <?php
							...
							?>  
								<tr>
									...
									<td><?php if($payment['transaction_type']==1){echo "Cash";}elseif($payment['transaction_type']==0){ echo "online";}else{ echo "Reverse";}?></td>	
									<td><?php echo $payment['emp_first_name'];?></td>
									<td><?php echo $payment['invoice'];?></td>
									<td><?php echo $payment['dateCreated'];?></td> 					
									<!--<td><a title="Reverse Payment" href="<?php echo base_url()?>customer/reverse_payment/<?php echo $row['cust_id']?>"><i class="fa fa-money fa-lg" aria-hidden="true"></i></a></td>-->
								</tr>
						<?php
							//} // if condition
							$i=$i+1;
