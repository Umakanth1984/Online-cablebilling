...
<div class="content-wrapper">
    ...
    <section class="content-header">
		<h1>Digital Cables  - Edit MSO Preferences</h1>
		<ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
			<li><a href="#">Settings</a></li>
			<li><a href="#">Preferences</a></li>
			<li class="active">Edit MSO Preferences</li>
		</ol>
    </section>
    ...
    <section class="content">
		<div class="row">
			<?php foreach($edit as $key => $emp_mso_data){}?>
			<?php if(isset($msg)){ echo $msg; } ?>
		<form id="customerForm" class="form-horizontal" role="form" method="post" autocomplete="off" action="<?php echo base_url()?>preferences/update_mso_prefer/<?php echo $emp_mso_data['mso_id'];?>"> 
        <!-- left column -->
			<div class="col-md-6">
				<div class="box box-info">
					<div class="box-header with-border">
						<h3 class="box-title">Edit MSO Preferences</h3>
					</div>
					<div class="box-body">
						<div class="form-group">
							<label for="mso" class="col-sm-4 control-label">MSO Name *</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="mso" id="mso" value="<?php echo $emp_mso_data['mso_name'];?>" placeholder="Enter MSO Name" required>
							</div>
						</div>
					</div>
