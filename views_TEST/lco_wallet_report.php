...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Digital Cables  - LCO Wallet List      
      </h1>
		<ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
			<li><a href="#">Reports</a></li>
			<li><a href="#">Franchise</a></li>
			<li class="active"><a href="#">LCO Wallet Wallet</a></li>
		</ol>
    </section>
			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h3 class="box-title">LCO Wallet List</h3>
						<div class="box-body">	
							<form id="customerForm12" name="customerForm12" class="form-horizontal" role="form" method="post" autocomplete="off" action="<?php echo base_url()?>excelsheet/lco_wallets">						
					...
					<form id="reportSearch" name="customerForm11" class="form-horizontal" role="form" method="post" autocomplete="off" action="">
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-md-4">
									...
									<div class="col-md-8">
										<input type="date" class="form-control" id="todate" name="todate" <?php if(isset($_REQUEST['todate']) && $_REQUEST['todate']!=''){?> value="<?php echo $_REQUEST['todate']; ?>" <?php }else{?>value="<?php echo date("Y-m-d");?>"<?php }?>>
									</div>
								</div>
								<?php
								    if($user_type==9)
				...
				<div class="box-body">
					<table id="example2" class="table table-bordered table-hover">
						...
						<tr>
							<td><?php echo $i;?></td>
							<td><?php echo $logInfo['empFname']." ".$logInfo['empLname'];?></td>
							<td><?php echo $logInfo['empMobile'];?></td>
							<td><?php echo $logInfo['balance'];?></td>
