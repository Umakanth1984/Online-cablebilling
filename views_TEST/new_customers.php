...
<div class="content-wrapper">
    ...
    <section class="content-header">
      	<h1>Digital Cables  - New Customers List</h1>
		<ol class="breadcrumb">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="box box-info">
					...
					<form id="customerForm11" name="customerForm11" class="form-horizontal" role="form" method="post" autocomplete="off" action="<?php echo base_url()?>reports/new_con">
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-md-3">
									<div class="col-md-12">
										<input type="date" class="form-control" id="fromdate" name="fromdate" value="<?php if(isset($_REQUEST['fromdate']) && $_REQUEST['fromdate']!=''){ echo $_REQUEST['fromdate'];}else{ echo date('Y-m-d',strtotime('-24 hours +00 minutes +00 seconds', strtotime(date('Y-m-d'))));} ?>" title="From Date">
									</div>
								</div>
								<div class="col-md-3">
									<div class="col-md-12">
										<input type="date" class="form-control" id="todate" name="todate" value="<?php if(isset($_REQUEST['todate']) && $_REQUEST['todate']!=''){ echo $_REQUEST['todate'];}else{ echo date('Y-m-d');} ?>" title="To Date">
									</div>
								</div>
								<div class="col-md-1">
				...
				<div class="box-body">
					<table id="example2" class="table table-bordered table-hover">
						...
						<tr>
							...
							<td><?php echo $active_customer_data['connection_date'];?></td>
							<td>Rs. <?php if($active_customer_data['install_charge']==''){ echo "0";}else{ echo $active_customer_data['install_charge'];}?></td>
						</tr>
						<?php
							$i++;
							$totAmt=$totAmt+$active_customer_data['install_charge'];
						}
						?>
						</tbody>
						<tfoot>
							<tr>
								<td colspan="11" align="center">Intallation Amount : <b style="color:red;font-size:24px;">Rs. <?php echo $totAmt;?></b></td>
							</tr>
						</tfoot>
					</table>
				</div>
