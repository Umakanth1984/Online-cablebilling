...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Digital Cables  - Deactive and Reactive List      
      </h1>
		<ol class="breadcrumb">
			<li><a  href="#"><i class="fa fa-dashboard"></i> Home</a></li>
			<li><a  href="#">Reports</a></li>
			<li><a  href="#">Customers</a></li>
			<li class="active"><a  href="#">Deactive and Reactive Customers</a></li>
		</ol>
    </section>
        ...
        <div class="col-xs-12">
			<div class="box">
				<div class="box-header">
				  <h3 class="box-title">Deactive and Reactive Customers List</h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
