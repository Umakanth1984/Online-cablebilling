...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Digital Cables  - Stock Transaction Inventory List      
      </h1>
		<ol class="breadcrumb">
			<li><a  href="#"><i class="fa fa-dashboard"></i> Home</a></li>
			<li><a  href="#">Reports</a></li>
			<li><a  href="#">Inventory</a></li>
			<li class="active"><a  href="#">Stock Transaction Inventory</a></li>
		</ol>
    </section>
        ...
        <div class="col-xs-12">
			<div class="box">
				<div class="box-header">
				  <h3 class="box-title">Stock Transaction Inventory List</h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
