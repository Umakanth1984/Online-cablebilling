...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Digital Cables  - Package Remove Requests
      </h1>
		<ol class="breadcrumb">
			<li><a  href="#"><i class="fa fa-dashboard"></i> Home</a></li>
			<li><a  href="#">Reports</a></li>
			<li><a  href="#">Franchise</a></li>
			<li class="active"><a  href="#">Package Remove Requests</a></li>
		</ol>
    </section>
			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h3 class="box-title">Package Remove Requests List</h3>
						<div class="box-body">	
							<form id="customerForm12" name="customerForm12" class="form-horizontal" role="form" method="post" autocomplete="off" action="<?php echo base_url()?>excelsheet/removal_requests">						
					...
					<form id="customerForm11" name="customerForm11" class="form-horizontal" role="form" method="post" autocomplete="off" action="<?php echo base_url()?>reports/removal_requests">
						<div class="box-body">
