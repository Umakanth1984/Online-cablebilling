...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Digital Cables  - Ala-carte Reject List      
      </h1>
		<ol class="breadcrumb">
			<li><a  href="#"><i class="fa fa-dashboard"></i> Home</a></li>
			<li><a  href="#">Reports</a></li>
			<li><a  href="#">Ala-carte Reject</a></li>
			<li class="active"><a  href="#">Ala-carte Reject</a></li>
		</ol>
    </section>
			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h3 class="box-title">Ala-carte Reject List</h3>
						<form id="customerForm12" name="customerForm12" class="form-horizontal" role="form" method="post" autocomplete="off" action="<?php echo base_url();?>excelsheet/ala_reject">
					...
					<form id="customerForm11" name="customerForm11" class="form-horizontal" role="form" method="post" autocomplete="off" action="<?php echo base_url()?>reports/ala_reject">
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-md-3">
									<div class="col-md-12">
										<select class="form-control" id="inputLco" name="inputLco" required>
				...
				<div class="box-body">
					<table id="example2" class="table table-bordered table-hover">
						...
						<?php
						$i=1;
						foreach($customer_rejects as $key => $customer_req1)
						{
						  //  print_r($customer_req1);
						    if(isset($customer_req1['bouquet'])){ $packName=$customer_req1['bouquet']['0']['package_name'];$packPrice=$customer_req1['bouquet']['0']['package_price'];}
