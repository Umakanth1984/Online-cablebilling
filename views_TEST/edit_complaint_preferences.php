...
<div class="content-wrapper">
    ...
    <section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Edit Complaint Categories Preferences</li>
		</ol>
    </section>
    ...
    <section class="content">
		<div class="row">
			<?php foreach($edit as $key => $edit_data){}?>
			<?php if(isset($msg)){ echo $msg; } ?>
		<form id="customerForm" class="form-horizontal" role="form" method="post" autocomplete="off" action="<?php echo base_url()?>preferences/update_complaint_prefer/<?php echo $edit_data['id']?>"> 
        <!-- left column -->
			<input type="hidden" name="id" id="id" value="<?php echo $edit_data['id']?>">
			<div class="col-md-6">
				<div class="box box-info">
					<div class="box-header with-border">
						<h3 class="box-title">Edit Complaint Categories</h3>
					</div>
				<!-- /.box-header -->
					<div class="box-body">
