...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
		...
		<?php 
			foreach($edit_inventory as $key => $emp_outward)
			{
			}
		?>
	 <form id="complaintsForm" class="form-horizontal" role="form" method="post" autocomplete="off" action="<?php echo base_url()?>emp_outward/emp_outward_updated/<?php echo $emp_outward['emp_outward_id'];?>"> 
        <!-- left column -->
        <div class="col-md-8">
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Employee Outward Inventory Details</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              <div class="box-body">
				...
				<div class="form-group col-md-6">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" id="outward_qty" name="outward_qty" value="<?php echo $emp_outward['outward_qty'];?>" placeholder=" Quantity No." required>
					</div>
				</div>			  
				 <div class="form-group col-md-6">
					<label for="Outward_qty" class="col-sm-4 control-label">Remarks</label>
					<div class="col-sm-8">
						<textarea class="form-control" id="outward_remarks" name="outward_remarks" placeholder=" Enter Remarks" required><?php echo $emp_outward['remarks'];?></textarea>
					</div>
				</div>	
				 <div class="form-group col-md-6">
